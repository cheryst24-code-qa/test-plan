# QA Documentation: [Название проекта]
...
graph TD
  ...
  B -->|❌ Ошибка плейсхолдеров| A
  B -->|✅ Пройдено| C[🟢 Утверждение PO / Dev Lead]
  C --> D[Тестирование + баги по CONTRIBUTING.md]
  D --> E[Фиксы & регресс]
  E --> F[Заполнение TEST_SUMMARY_REPORT.md]
  F --> G{✅ Вердикт: готово к релизу?}
  G -->|🔴 Нет| D
  G -->|🟢 Да| H[Релиз + архивация отчёта]
...
- [CI-валидация](.github/workflows/validate-docs.yml)

---
*Документация поддерживается QA-командой. При изменениях процесса обновляйте этот `README.md` и создавайте PR.*